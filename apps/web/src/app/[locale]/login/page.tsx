          ...
          {accountType === 'player' && (
            <div className="mb-6 space-y-3">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl text-sm font-semibold text-white transition-all duration-150 shadow-sm hover:brightness-110 active:brightness-95"
